<div class="p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('crm::crm.edit_lead') }}</h2>
            <p class="text-gray-500 text-sm mt-1">{{ __('crm::crm.edit_lead_description') }}</p>
        </div>
    </div>
