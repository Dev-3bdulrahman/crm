<div class="p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('crm::crm.create_opportunity') }}</h2>
            <p class="text-gray-500 text-sm mt-1">{{ __('crm::crm.create_opportunity_description') }}</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
        <form wire:submit.prevent="save" class="p-6 space-y-6">
            ...
            <div class="flex items-center justify-end gap-3 border-t border-gray-100 dark:border-gray-800 pt-6">
                <a href="{{ route('admin.crm.opportunities') }}"
